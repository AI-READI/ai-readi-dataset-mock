...
Before you ask a question, it is best to search for existing [Issues](https://github.com/AI-READI/high-level-dataset-structure/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/AI-READI/high-level-dataset-structure/issues).
...
- Open an [Issue](https://github.com/AI-READI/high-level-dataset-structure/issues/new). 
...
- Perform a [search](https://github.com/AI-READI/high-level-dataset-structure/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
